...
function App() {
  return (
    <div className="App">
      ...
      <Project name="Random Forest Regression" link="" image="Images/Taxi.png" description="finding the best parameters for predicting the fare of taxi rides with Random Forest Regression" used_technologies={["Python","pandas","numpy", "matplotlib","sklearn", "surprise library" , "Google Colab"]} />
      <Project name="Image Classification with CNNs" link="" image="Images/CNN.png" description="building and training of the AlexNet CNN architecture for the CIFAR 10 data set, optimization the learning hyper-paramters to get the best test accuracy" used_technologies={["Python","pandas","numpy", "matplotlib","sklearn", "surprise library" , "Google Colab"]} />
      </div>
